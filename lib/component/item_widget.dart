...
class ItemWidget extends StatelessWidget {
  TopType tapType;
  ItemWidget({required this.imgUrl, required this.textTitle, required this.malId, required this.tapType});
  final String imgUrl;
  ...
  Future<dynamic> animeTapDetails() async {
    return await tapDetails.animeTap(malId);
  }

  Future<dynamic> mangaTapDetails() async {
    return await tapDetails.mangaTap(malId);
  }
